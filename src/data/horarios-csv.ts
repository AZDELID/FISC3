...
// Cargar datos directamente desde el archivo CSV importado
import csvRawData from '../imports/pasted_text/horario-cursos.csv?raw';

export const horariosCSVData: HorarioCSV[] = parseCSVToHorarios(csvRawData);